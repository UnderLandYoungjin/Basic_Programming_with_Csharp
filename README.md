...
**UnderLand — 3D필라멘트 반자동화 생산라인 셋업 및 3D필라멘트 개발**

**AI Vision — AI 기반 운전자 모니터링 시스템 개발**

---
## 💼 활동분야

**현) 양산직업학교 출강(C/C++아두이노) / 부산 폴리텍하이테크과정 소프트웨어 융합과정 외래강사(기본프로그래밍C#강의)**
...
> 문법만 외우는 공부가 아니라, **직접 만들어보는 경험**이 실력이 됩니다.

- C# 기초 문법 완성 — 변수, 조건문, 반복문, 클래스, GUI
- **미니 프로젝트 완성** — 계산기, 성적 관리, 간단한 게임 등
- 작은 프로젝트라도 **완성까지 끝내는 습관**이 핵심입니다
- **자격증 도전** — 단계적으로 실력을 검증하세요
- 기능사 · 산업기사 · 기사
...
> 1학기에 쌓은 기초 위에 **AI · 임베디드 · 웹** 기술을 더해 실전 프로젝트를 완성합니다.

- AI Vision — Python, OpenCV, YOLO, MediaPipe
- 임베디드 — AVR, IoT
- 웹 / 대시보드 — Flask, FastAPI, React, Blazor
- **포트폴리오 프로젝트** — 취업을 목표로 한 실전 프로젝트 제작
- 취업 준비 — 자기소개서 작성 · 기술면접 대비

---

## 🐙 평소 공부는 GitHub 또는 카페에 정리하기

> 꾸준히 쌓인 커밋 기록이 **나의 성장을 증명하는 포트폴리오**가 됩니다.

- 수업 실습 코드, 미니 프로젝트를 꾸준히 커밋하세요
- README를 작성하는 습관을 들이세요 — 설명할 수 있어야 진짜 아는 것입니다
- 취업 시 GitHub 링크 하나가 이력서보다 강력한 무기가 될 수 있습니다

---

> **이 수업이 그 첫걸음이 되길 바랍니다.** 🎯
